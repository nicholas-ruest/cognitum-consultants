...
mod tests {
    ...
    /// Stub `EduGateway` for dashboard tests, same rationale as
    /// `UnusedCommitGateway` above (PROMPT-35).
    ...
    impl nexus_client::EduGateway for UnusedEduGateway {
        async fn request_learning_catalog(
            ...
            unimplemented!("dashboard tests never call the edu gateway")
        }
    }

    /// Stub `CapacityGateway` for dashboard tests, same rationale as
    ...
    impl nexus_client::CapacityGateway for UnusedCapacityGateway {
        async fn update_own_profile(
            ...
            unimplemented!("dashboard tests never call the capacity gateway")
        }
    ...
    impl nexus_client::ProductsGateway for UnusedProductsGateway {
        async fn request_product_catalog(
            ...
            unimplemented!("dashboard tests never call the products gateway")
        }
    }
    ...
    impl nexus_client::LandscapeGateway for UnusedLandscapeGateway {
        async fn request_intelligence_digest(
            ...
            unimplemented!("dashboard tests never call the landscape gateway")
        }
    ...
    impl nexus_client::LegalGateway for UnusedLegalGateway {
        async fn request_approved_clauses(
            ...
            unimplemented!("dashboard tests never call the legal gateway")
        }
    }
